$(function () {
  ...
  $('.service-slide').slick({
    ...
    initialSlide: 1,
    vertical: true,
    prevArrow: '.service-top-arrow',
    nextArrow: '.service-bottom-arrow',
    centerMode: true,
    centerPadding: '0px',
    responsive: [
    //  for medium device
  ...
  // comment left slider start
  $('.comment-left-slide').slick({
    slidesToShow: 3,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 2000,
    ...
    vertical: true,
    initialSlide: 1,
    prevArrow: '.comment-top-arrow',
    nextArrow: '.comment-bottom-arrow',
    centerMode: true,
    centerPadding: '0px',
    asNavFor: '.comment-right-slide',
    responsive: [
      //  for xtra small device
        {
          breakpoint: 768,
  ...
  // comment left slider end


  // comment right slider start
  $('.comment-right-slide').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 2000,
    ...
    initialSlide: 1,
    // vertical:true,
    asNavFor: '.comment-left-slide'
  });
  // comment right slider end
